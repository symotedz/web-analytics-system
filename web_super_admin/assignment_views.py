...
def assignment_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('/super_admin/assignments_detail/')
    else:
        form = AssignmentForm(request.POST)
    context = {
        'form' : form
    }
    return render(request, 'Dashboard/assignment_create.html', context)
...
def assignment_update(request, pk):
    ...
    return render(request, 'Dashboard/assignment_update.html', context)
...
def assignments_delete(request):
    ...
    assignment.delete()
    return redirect('/super_admin/assignment_detail/')
