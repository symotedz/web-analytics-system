...
def library_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('/super_admin/librarys_detail/')
    else:
        form = LibraryItemForm(request.POST)
    context = {
        'form' : form
    }
    return render(request, 'Dashboard/library_create.html', context)
...
def librarys_detail(request):
    ...
    return render(request, 'Dashboard/librarys_detail.html', context)
...
def library_detail(request, pk):
    ...
    return render(request, 'Dashboard/library_detail.html', context)
...
def library_update(request, pk):
    ...
    return render(request, 'Dashboard/library_update.html', context)
...
def librarys_delete(request):
    ...
    library.delete()
    return redirect('/super_admin/library_detail/')
