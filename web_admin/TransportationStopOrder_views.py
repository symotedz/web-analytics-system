...
def TransportationStopOrder_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('/web_admin/TransportationStopOrders_detail/')
    else:
        form = TransportationStopOrderForm(request.POST)
    context = {
        'form' : form
    }
    return render(request, 'webadmin/TransportationStopOrder_create.html', context)
...
def TransportationStopOrders_detail(request):
    ...
    return render(request, 'webadmin/TransportationStopOrders_detail.html', context)
...
def TransportationStopOrder_detail(request, pk):
    ...
    return render(request, 'webadmin/TransportationStopOrder_detail.html', context)
...
def TransportationStopOrder_update(request, pk):
    ...
    return render(request, 'webadmin/TransportationStopOrder_update.html', context)
...
def TransportationStopOrders_delete(request):
    ...
    transportationStopOrder.delete()
    return redirect('/web_admin/TransportationStopOrder_detail/')
