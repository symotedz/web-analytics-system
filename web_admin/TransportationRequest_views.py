...
def TransportationRequest_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('/web_admin/TransportationRequests_detail/')
    else:
        form = TransportationRequestForm(request.POST)
    context = {
        'form' : form
    }
    return render(request, 'webadmin/TransportationRequest_create.html', context)
...
def TransportationRequests_detail(request):
    ...
    return render(request, 'webadmin/TransportationRequests_detail.html', context)
...
def TransportationRequest_detail(request, pk):
    ...
    return render(request, 'webadmin/TransportationRequest_detail.html', context)
...
def TransportationRequest_update(request, pk):
    ...
    return render(request, 'webadmin/TransportationRequest_update.html', context)
...
def TransportationRequests_delete(request):
    ...
    transportationRequest.delete()
    return redirect('/web_admin/TransportationRequest_detail/')
