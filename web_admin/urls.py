...
urlpatterns = [
    ...
    path('admin_teacher_create/', teacher_views.admin_teacher_create, name='admin_teacher_create'),
    path('admin_teachers_detail/', teacher_views.admin_teachers_detail, name='admin_teachers_detail'),
