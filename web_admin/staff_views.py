...
def staff_create(request):
    ...
    return render(request, 'webadmin/staff_create.html', context)
...
def staffs_detail(request):
    ...
    return render(request, 'webadmin/staffs_detail.html', context)
...
def staff_detail(request, pk):
    ...
    return render(request, 'webadmin/staff_detail.html', context)
...
def staff_update(request, pk):
    ...
    return render(request, 'webadmin/staff_update.html', context)
